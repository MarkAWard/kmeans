...
\begin{frame}{Comments}
  \begin{itemize}
  \item The best method for parallelization will depend on your data
  \item There are much better methods for initializing the centroids to converge faster, kmeans++
  \item Reading plain text files with MPI is annoying
  \item Every now and then communication would hang (locally) for a long time before
  \item Saw some errors/warnings when running on Mercer for larger data that I didn't see previously
  \end{itemize}
\end{frame}

\begin{frame}{huhh??}
\begin{figure}
	\includegraphics[keepaspectratio=true, width=4.5in]{bug.png}
\end{figure}
\end{frame}
...
\newblock{\em k-means++: The advantages of careful seeding}
\newblock Proceedings of the eighteenth annual ACM-SIAM symposium on Discrete algorithms. (2007) 1027-1035
